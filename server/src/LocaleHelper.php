...
class LocaleHelper
{
    ...
    public static function getLocalesListWithTranslation(string $trans): array
    {
        $x = [];
        foreach (self::getLocalesList() as $k => $v) {
            $x[$k] = sprintf("%s // %s", Locale::getDisplayName($k, $trans), $k);
        }
        return $x;
    }

    /**
     * @link https://github.com/umpirsky/locale-list/blob/master/data/en_US/locales.php
     */
